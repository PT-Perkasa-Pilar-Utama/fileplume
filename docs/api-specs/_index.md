...
| Operation | Spec | Sprint | Status |
|---|---|---|---|
| `GET /configuration` | [04 4.2](04-configuration.md) | 2 | OK |
| `PATCH /configuration/:key` | [04 4.3](04-configuration.md) | 2 | OK |
| `DELETE /configuration/:key` | [04 4.4](04-configuration.md) | 2 | OK |
...
| `GET /documents/:id/versions` | [05 5.6](05-documents.md) | 2 | OK |
| `POST /documents/:id/versions` | [05 5.7](05-documents.md) | 2 | OK |
